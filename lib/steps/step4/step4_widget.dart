...
import '/components/update_count_solicitud_widget.dart';
    ...
    return StreamBuilder<List<SolicitudEventoPorAplicanteRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SolicitudEventoPorAplicanteRecord>
            step4SolicitudEventoPorAplicanteRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final step4SolicitudEventoPorAplicanteRecord =
            step4SolicitudEventoPorAplicanteRecordList.isNotEmpty
                ? step4SolicitudEventoPorAplicanteRecordList.first
                : null;
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if (_model.responseJsonApplicationRequest !=
                                          ...
                                          (_model.responseJsonApplicationRequest)!
                                              .isNotEmpty) {
                                        FFAppState().purchaseDetails = _model
                                            .responseJsonApplicationRequest!
                                            .toList()
                                            .cast<dynamic>();
                                        FFAppState().update(() {});
                                      }
                                                  ...
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                            'Descripción: ${listViewProductoRecord.descripcion}',
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                            'Color:${listViewProductoRecord.color}',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
                                                                .override(
