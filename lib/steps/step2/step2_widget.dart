...
class _Step2WidgetState extends State<Step2Widget> {
  ...
  void initState() {
    ...
    _model.txtEventTypeTextController ??= TextEditingController();
    _model.txtEventTypeFocusNode ??= FocusNode();

    _model.txtTopicTextController ??= TextEditingController();
    _model.txtTopicFocusNode ??= FocusNode();

    _model.txtColoresTextController ??= TextEditingController();
    _model.txtColoresFocusNode ??= FocusNode();

    _model.txtCommentTextController ??= TextEditingController();
    ...
    return StreamBuilder<List<SolicitudEventoPorAplicanteRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SolicitudEventoPorAplicanteRecord>
            step2SolicitudEventoPorAplicanteRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final step2SolicitudEventoPorAplicanteRecord =
            step2SolicitudEventoPorAplicanteRecordList.isNotEmpty
                ? step2SolicitudEventoPorAplicanteRecordList.first
                : null;
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  5.0, 0.0, 0.0, 0.0),
                              child: Text(
                                'Ingreso de datos de la temática',
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.txtEventTypeTextController,
                                        focusNode: _model.txtEventTypeFocusNode,
                                        autofocus: true,
                                        ...
                                        validator: _model
                                            .txtEventTypeTextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ),
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.txtTopicTextController,
                                        focusNode: _model.txtTopicFocusNode,
                                        autofocus: true,
                                        autofillHints: [AutofillHints.email],
                                        obscureText: false,
                                        decoration: InputDecoration(
                                        ...
                                        keyboardType:
                                            TextInputType.emailAddress,
                                        validator: _model
                                            .txtTopicTextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ),
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.txtColoresTextController,
                                        focusNode: _model.txtColoresFocusNode,
                                        autofocus: true,
                                        autofillHints: [AutofillHints.email],
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelText: 'Colores de preferencia',
                                          labelStyle: FlutterFlowTheme.of(
                                                  context)
                                              .labelMedium
                                              .override(
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.txtCommentTextController,
                                  ...
                                  Builder(
                                    builder: (context) {
                                      final galerias = _model.uploadedFileUrls
                                          .map((e) => e)
                                          .toList();
                                      ...
                                      return Row(
                                        ...
                                        children: List.generate(galerias.length,
                                            (galeriasIndex) {
                                          final galeriasItem =
                                              galerias[galeriasIndex];
                                          return ClipRRect(
                                            borderRadius:
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          if ((_model.txtEventTypeTextController
                                                          .text !=
                                                      null &&
                                                  _model.txtEventTypeTextController
                                                          .text !=
                                              ...
                                              (_model.txtColoresTextController
                                                  ...
                                                  _model.txtColoresTextController
                                                          .text !=
                                                      '')) {
                                            if (step2SolicitudEventoPorAplicanteRecord !=
                                                null) {
                                              await widget!.prmIdSolicitud!
                                                  .update({
                                                ...createSolicitudEventoPorAplicanteRecordData(
                                                  tipoDeEvento: _model
                                                      .txtEventTypeTextController
                                                      .text,
                                                  tematica: _model
                                                      .txtTopicTextController
                                                      .text,
                                                  coloresDePreferencia: _model
                                            ...
                                            ScaffoldMessenger.of(context)
                                              ...
                                              SnackBar(
                                                content: Text(
                                                  'Los siguientes campos son requeridos: Tipo Evento, Temática, Colores Preferencia',
                                                  style: TextStyle(
